"""
Django settings for VTchat project.
...
ALLOWED_HOSTS = ['Vtchat-app-env.eba-pq3mupzz.ap-southeast-2.elasticbeanstalk.com']
...
WSGI_APPLICATION = 'VTchat.wsgi.application'
...
CHANNEL_LAYERS = {
        "default": {
            ...
            "CONFIG": {
                "hosts": [(config('CHANNEL_LAYERS_HOST'), 6379)],
            },
        },
    }
